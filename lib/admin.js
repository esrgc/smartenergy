...
const geocoder = require('mdimapgeocoder');
...
const counties = require('./maryland-counties-single.json');
const legislative = require('./maryland-legislative-districts-single.json');
const congressional = require('./maryland-congressional-districts-single.json');
const zips = require('./maryland-zips-single.json');
const cities = require('./maryland-cities.json');
const intersection_lookup = require('./intersection_lookup.json');
