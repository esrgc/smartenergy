...
var columns = {
  'energyeffiency': ['mea_award', 'leveraged_utility_funds','total_project_cost',
  ...
  'renewableenergy': ['mea_award', 'total_project_cost','other_agency_dollars','co2_emissions_reductions_tons','capacity', 'date'],
  'transportation': ['mea_award', 'total_project_cost','other_agency_dollars','leveraged_utility_funds',
    ...
    docs.forEach(function(doc, idx) {
      ...
      columns[tab].forEach(function(col) {
        if (col === 'date') {
          ...
          doc[col] = doc[col] ? parseInt(doc[col].replace(/,/g, "")) : 0
        }
      })
